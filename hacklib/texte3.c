...
status_t __real_convert_from_utf8__FUlPCcPlPcT2T2c(unsigned long a, char const *b, long *c, char *d, long *e, long *f, char g)
{
	return __wrap_convert_from_utf8__FUlPCcPlPcT2T2c(a, b, c, d, e, f, g);
}
...
*/
status_t __real_convert_to_utf8__FUlPCcPlPcT2T2c(unsigned long a, char const *b, long *c, char *d, long *e, long *f, char g)
{
	return __wrap_convert_to_utf8__FUlPCcPlPcT2T2c(a, b, c, d, e, f, g);
}
/*
status_t convert_to_utf8__FUlPCcPlPcT2T2c(unsigned long a, char const *b, long *c, char *d, long *e, long *f, char g)
